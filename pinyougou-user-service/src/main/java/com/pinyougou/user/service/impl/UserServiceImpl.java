...
public class UserServiceImpl implements UserService {
	...
	public PageResult findPage(TbUser user, int pageNum, int pageSize) {
		...
		public void createSmscode(final String phone) {
			...
			//生成6位随机
			final String code=(long)(Math.random()*1000000)+"";// new Random().nextInt(900000)+100000
...
//					message.setString("template_code","SMS_138062739");
//					message.setString("sign_name", "\\u6B66\\u6C49\\u901F\\u8FD0\\u5FEB\\u9012");//签名
					Map map=new HashMap<>();
					map.put("number", code);
